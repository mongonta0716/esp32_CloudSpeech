...
CloudSpeechClient::CloudSpeechClient(const char* root_ca, Authentication authentication, String project_id) {
...
String CloudSpeechClient::Transcribe(Audio* audio, String access_token) {
  ...
  String HttpHeaders = String("POST /v1/speech:recognize HTTP/1.1\r\nx-goog-user-project: " + project_id + "\r\nHost: speech.googleapis.com\r\nContent-Type: application/json\r\nContent-Length: " + httpBody2Length + "\r\n\"Authorization: Bearer ")
    + access_token + String("\"\r\n\r\n");
